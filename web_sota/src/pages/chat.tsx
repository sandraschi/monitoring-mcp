                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex-1 space-y-1">
                            ...
                            <p className="text-sm text-slate-300 bg-slate-900/50 p-3 rounded-md border border-slate-800 inline-block">
                                Check CPU temperatures and report any anomalies from the last hour.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex-1 space-y-1">
                            ...
                            <div className="text-sm text-slate-300 bg-blue-950/10 p-3 rounded-md border border-blue-900/30 inline-block">
                                <p>Analyzing Prometheus telemetry data...</p>
                                <br />
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2 p-2 bg-slate-900/80 rounded border border-slate-800">
                                        <Activity className="h-3 w-3 text-blue-400" />
                                        <span className="text-xs text-blue-300">CPU Package: 54°C (Nominal)</span>
                                    </div>
                                    <p className="text-xs text-emerald-400 font-mono">
                                        {">"} ANOMALY_DETECTION: NO_ISSUES_FOUND <br />
                                        {">"} TREND: STABLE (-2°C deviation)
                                    </p>
                                </div>
                            </div>
                        </div>
